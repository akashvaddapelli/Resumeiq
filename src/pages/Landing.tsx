        ...
        <div className="container relative z-10 mx-auto px-4 text-center">
          ...
          >
            ...
            <h1 className="font-heading text-5xl font-extrabold leading-tight tracking-tight sm:text-6xl lg:text-7xl">
              <span className="text-foreground">Ace Every</span>
              <br />
              <span className="gradient-text">Interview</span>
            </h1>

            <p className="mx-auto mt-6 max-w-lg text-lg text-muted-foreground">
              Upload your resume, describe the role, and get personalized interview questions with AI-powered feedback.
            </p>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <a href="#features">
                <Button variant="outline" size="lg" className="rounded-xl border-border/50 px-8 text-base text-muted-foreground hover:text-foreground hover:border-primary/30">
                  See Features
                </Button>
              </a>
            </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <motion.p variants={fadeUp} custom={1} className="mt-4 text-muted-foreground">
              From resume analysis to mock interviews — all powered by AI.
            </motion.p>
          </motion.div>
      ...
      <section id="how-it-works" className="py-24">
        <div className="container mx-auto px-4">
          <motion.h2
            ...
            className="text-center font-heading text-3xl font-bold text-foreground sm:text-4xl mb-16"
          >
        ...
        <div className="container mx-auto px-4 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <motion.div variants={fadeUp} custom={1} className="mt-8">
              <Link to="/auth?mode=signup">
                <Button size="lg" className="glow-button rounded-xl px-10 text-base font-semibold text-primary-foreground">
      ...
      <footer className="border-t border-border/50 py-8">
        <div className="container mx-auto flex items-center justify-between px-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-heading text-sm font-semibold text-foreground">Intervu</span>
          </div>
          <p className="text-xs text-muted-foreground">© 2026 Intervu. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
